...
df_vendas = pd.read_excel("tarefa_1/vendas.xlsx", sheet_name="Pagamentos")
df_comissao = pd.read_excel("tarefa_1/resultado_comissoes.xlsx", sheet_name="Comissão")
...
resultado.to_excel(
    "tarefa_2/comissao_correta.xlsx", index=False, sheet_name="Comissão correta"
)

# Carregar a planilha criada
wb = load_workbook("tarefa_2/comissao_correta.xlsx")
ws = wb.active
...
# Salva a planilha
wb.save("tarefa_2/comissao_correta.xlsx")
